...
public class Prjava43ramon18 extends Frame
   ...
   public Prjava43ramon18 () {
      ...
      setTitle("nova finestra prjava43ramon18");  // "this" Frame sets title
   ...
   public static void main(String[] args) {
      new Prjava43ramon18();  // Let the construct do the job
   }
